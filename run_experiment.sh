...
srun python test.py --config 'configs/autoregressive/8layer_config.yaml' --model 'NodeEdgeGNN' --model_path 'num_gnn_layers/model/NodeEdgeGNN_2025-09-17_20-02-44_12layer.pt'
srun python test.py --config 'configs/autoregressive/8layer_config.yaml' --model 'NodeEdgeGNN' --model_path 'num_gnn_layers/model/NodeEdgeGNN_2025-09-17_20-33-26_14layer.pt'
srun python test.py --config 'configs/autoregressive/8layer_config.yaml' --model 'NodeEdgeGNN' --model_path 'num_gnn_layers/model/NodeEdgeGNN_2025-09-17_21-07-08_16layer.pt'
